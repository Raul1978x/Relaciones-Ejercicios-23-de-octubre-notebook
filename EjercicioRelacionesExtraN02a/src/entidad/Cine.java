...
public class Cine {
    ...
    public void menuCine() {
        ...
        do {
            ...
            System.out.println("1.- Cargar peliculas de la Cartelera\n"
                    + "2.- Asignar asiento a Espectador\n"
                    + "3.- Mostrar Sala\n"
                    + "4.- Mostrar Cartelera de películas\n"
                    + "x.- Salir");
            System.out.println("**************************************");
            op = leer.next();
            switch (op) {
                case "1":
                    servicioPelicula.cargarPeliculas();
                    break;
                case "2":
                    servicioPersona.crearPersona();
                    
                    servicioSala.asignarAsiento();
                    break;
                case "3":
                    servicioSala.mostrarSala();
                    break;
                case "4":
                    servicioPelicula.imprimirCartelera();
                    break;
                case "x":
